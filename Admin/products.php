...
<!-- /HEADER -->
			...
			<section id="middle">
				...
				<header id="page-header">
					<h1><strong>Listes des produits</strong></h1>
					<ol class="breadcrumb">
						<li><a href="#">Tables</a></li>
						<li class="active">Listes de produits</li>
					</ol>
				</header>
				<!-- /page title -->
					...
					<div id="panel-1" class="panel panel-default">
						<div class="panel-heading">
							<span class="title elipsis">
								<strong>Base de Données des produits</strong><a href="insert.php" class="btn btn-success"><span class="glyphicon glyphicon-plus">Ajouter</span></a> <!-- panel title -->
							</span>
							...
							<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
								...
								<tbody>
									<?php
										...
										$db = Database::connect();
										$statement = $db->query('SELECT products.id, products.product_name, products.product_price, products.product_desc, products.product_image, products.product_keywords, 
																	categories.name AS categorie FROM products LEFT JOIN categories ON products.product_cat = categories.id ORDER BY id DESC');
										while ($items = $statement->fetch()) {
											echo '<tr>';
											echo '<td>'. $items['product_name'] . '</td>';
											echo '<td><img src="../assets/images/resto-images/' . $items['product_image'] . '" width="50" alt=""></td>';
											echo '<td>'. number_format((float)$items['product_price'],2, '.','') . '</td>';											
											echo '<td>'. $items['product_desc'] . '</td>';
											echo '<td>'. $items['categorie'] . '</td>';
											echo '<td>'. $items['product_keywords'] . '</td>';
											echo '<td width=300>';
											echo '<a class="btn btn-default" href="view.php?id='. $items['id'] . '"><span class="glyphicon glyphicon-eye-open"></span> Voir</a>';
											echo '<a class="btn btn-blue" href="update-copy.php?id='. $items['id'] . '"><span class="glyphicon glyphicon-pencil"></span> Modifier</a>';
