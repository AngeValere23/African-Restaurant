...
<!-- /HEADER -->
			...
			<section id="middle">
				...
				<header id="page-header">
					<h1><strong>Listes des categories</strong></h1>
					<ol class="breadcrumb">
						<li><a href="#">Tables</a></li>
						<li class="active">Listes des categorie</li>
					</ol>
				</header>
				<!-- /page title -->
					...
					<div id="panel-1" class="panel panel-default">
						<div class="panel-heading">
							<span class="title elipsis">
								<strong>Base de Données des Categories</strong><a href="#" class="btn btn-success"><span class="glyphicon glyphicon-plus">Ajouter</span></a> <!-- panel title -->
							</span>
							...
							<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
								...
								<tbody>
									<?php
										...
										$db = Database::connect();
										$statement = $db->query('SELECT * FROM categories ORDER BY id DESC');
										while ($cat = $statement->fetch()) {
											echo '<tr>';
											echo '<td>'. $cat['name'] . '</td>';
											echo '<td width=300>';
											echo '<a class="btn btn-blue" href="#"><span class="glyphicon glyphicon-pencil"></span> Modifier</a>';
